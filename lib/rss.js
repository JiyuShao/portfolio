...
import { getPostBlocksWithChildren, transformToRecordMap } from '@/lib/notion'
...
const createFeedContent = async post => {
  const content = ReactDOMServer.renderToString(
    <ConfigProvider value={clientConfig}>
      <NotionRenderer recordMap={transformToRecordMap(await getPostBlocksWithChildren(post.id))} />
    </ConfigProvider>
  )
