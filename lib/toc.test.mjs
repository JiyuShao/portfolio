...
test('getToc normalizes historical resource-section headings', () => {
  const toc = getToc('# Reference\n\n## References\n\n## 参考链接')
  assert.deepEqual(toc.map(t => t.text), ['References', 'References', 'References'])
  assert.deepEqual(toc.map(t => t.id), ['references', 'references-2', 'references-3'])
})
